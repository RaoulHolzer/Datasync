...
public class Integration_Push_WithLazyLoading_Tests : ServiceTest, IClassFixture<ServiceApplicationFactory>, IDisposable
{

    private readonly IntegrationDbContext context;

    #region Setup
    public Integration_Push_WithLazyLoading_Tests(ServiceApplicationFactory factory) : base(factory)
    {
        this.context = GetOfflineContext(enableLazyoading: true);
    }
    #endregion
